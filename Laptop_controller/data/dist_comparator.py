...
dist_data = pd.read_csv("./dist_kalman_s1_V4_2.csv", header=None, names=["idx", "dist"])
x1 = dist_data['idx']          
y11 = dist_data['dist'].astype(float).round(3)

dist_data2 = pd.read_csv("./dist_kalman_s2_V4_2.csv", header=None, names=["idx", "dist"])
x2 = dist_data2['idx']
...
plt.savefig('../plots/dist_kalman_V4_2.png')
